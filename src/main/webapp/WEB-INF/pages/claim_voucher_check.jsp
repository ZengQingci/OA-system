...
<%@ page import="com.object.oasystem.global.Contant" %>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.loginUser.post==Contant.POST_FM || sessionScope.loginUser.post==Contant.POST_GM}">
                                ...
                                <c:if test="${sessionScope.loginUser.post==Contant.POST_CASHIER}">
